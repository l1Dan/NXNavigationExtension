...
+ (NSArray<TableViewSection *> *)makeAllSections {
    NSArray *items1 = @[
        ...
        [TableViewSectionItem itemWithTitle:@"UIScrollView with NXNavigationBar" itemType:TableViewSectionItemTypeNavigationBarScrollView],
    ...
    NSArray *items2 = @[
        ...
        [TableViewSectionItem itemWithTitle:@"启用全屏手势滑动返回" itemType:TableViewSectionItemTypeNavigationBarFullscreenPopGesture],
        ...
        [TableViewSectionItem itemWithTitle:@"WKWebView with NXNavigationBar" itemType:TableViewSectionItemTypeNavigationBarWebView],
