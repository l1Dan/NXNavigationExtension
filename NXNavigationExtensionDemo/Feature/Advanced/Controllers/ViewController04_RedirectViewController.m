...
- (void)showChooseJumpViewController {
    ...
    [HierarchyViewController showFromViewController:self
        ...
        [weakSelf.navigationController nx_redirectViewControllerClass:[selectedViewController class] initializeStandbyViewControllerUsingBlock:^__kindof UIViewController * _Nonnull{
