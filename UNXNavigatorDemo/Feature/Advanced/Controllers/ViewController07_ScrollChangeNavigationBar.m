...
- (void)viewDidLoad {
    ...
    [self.unx_navigationBar addContainerSubview:self.fakeNavigationBar];
    
    self.unx_navigationBar.alpha = 0.0;
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    CGFloat navigationBarHeight = CGRectGetHeight(self.unx_navigationBar.frame);
    CGFloat alpha = MAX(0.0, MIN(1.0, (offsetY - imageViewHeight + navigationBarHeight) / CGRectGetHeight(self.unx_navigationBar.frame)));
    self.unx_navigationBar.alpha = alpha;
