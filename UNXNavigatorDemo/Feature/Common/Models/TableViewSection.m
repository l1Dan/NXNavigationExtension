...
+ (NSArray<TableViewSection *> *)makeAllSections {
    NSMutableArray *items1 = [NSMutableArray arrayWithObjects:
                              ...
                              [TableViewSectionItem itemWithTitle:@"UIScrollView with UNXNavigationBar" itemType:TableViewSectionItemTypeNavigationBarScrollView],
    ...
    NSMutableArray *items2 = [NSMutableArray arrayWithObjects:
                              ...
                              [TableViewSectionItem itemWithTitle:@"WKWebView with UNXNavigationBar" itemType:TableViewSectionItemTypeNavigationBarWebView],
