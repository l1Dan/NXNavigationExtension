...
class ViewController03_BackButtonEventIntercept: BaseTableViewController {
    ...
    @objc
    private func clickPopViewControllerButton(_ button: UIButton) {
    ...
    private func showAlertController(in viewController: UIViewController) {
        ...
        alertController.addAction(UIAlertAction(title: NSLocalizedString("yes", comment: ""), style: .destructive, handler: { [weak self] _ in
