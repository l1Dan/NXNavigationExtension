...
- (void)viewDidLoad {
    ...
    [self.unx_navigationBar addSubview:self.gaussianBlurView];
    
    [self.gaussianBlurView.topAnchor constraintEqualToAnchor:self.unx_navigationBar.topAnchor].active = YES;
    [self.gaussianBlurView.leftAnchor constraintEqualToAnchor:self.unx_navigationBar.leftAnchor].active = YES;
    [self.gaussianBlurView.bottomAnchor constraintEqualToAnchor:self.unx_navigationBar.bottomAnchor].active = YES;
    [self.gaussianBlurView.rightAnchor constraintEqualToAnchor:self.unx_navigationBar.rightAnchor].active = YES;
}
