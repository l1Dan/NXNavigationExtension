...
typedef NS_ENUM(NSUInteger, TableViewSectionItemType) {
    ...
    TableViewSectionItemTypeNavigationBarScrollView, // UIScrollView with UNXNavigationBar
    ...
    TableViewSectionItemTypeNavigationBarWebView, // WKWebView with UNXNavigationBar
