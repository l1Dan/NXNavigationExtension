...
- (void)showChooseJumpViewController {
    ...
    [HierarchyViewController showFromViewController:self
        ...
        [weakSelf.navigationController unx_redirectViewControllerClass:[selectedViewController class] createViewControllerUsingBlock:^__kindof UIViewController * _Nonnull{
