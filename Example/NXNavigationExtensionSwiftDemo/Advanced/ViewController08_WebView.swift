...
class ViewController08_WebView: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        nx_navigationBar.addSubview(progressView)
        webView.load(URLRequest(url: requestURL))

        progressView.topAnchor.constraint(equalTo: nx_navigationBar.bottomAnchor).isActive = true
        progressView.leftAnchor.constraint(equalTo: nx_navigationBar.leftAnchor).isActive = true
        progressView.rightAnchor.constraint(equalTo: nx_navigationBar.rightAnchor).isActive = true
...
extension ViewController08_WebView: NXNavigationExtensionInteractable {
