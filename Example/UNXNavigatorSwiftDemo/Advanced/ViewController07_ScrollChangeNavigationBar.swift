...
class ViewController07_ScrollChangeNavigationBar: BaseTableViewController {
    ...
    override func viewDidLoad() {
        ...
        unx_navigationBar.addContainerSubview(fakeNavigationBar)
        
        unx_navigationBar.alpha = 0.0
        barStyle = .lightContent
        
        setNeedsStatusBarAppearanceUpdate()

        let containerView = unx_navigationBar.containerView
    ...
    override var unx_containerViewWithoutNavigtionBar: Bool {
        return true
    }
...
extension ViewController07_ScrollChangeNavigationBar {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        let navigationBarHeight = unx_navigationBar.frame.height
        let alpha = CGFloat.maximum(0.0, CGFloat.minimum(1.0, (offsetY - imageViewHeight + navigationBarHeight) / unx_navigationBar.frame.height))

        unx_navigationBar.alpha = alpha
