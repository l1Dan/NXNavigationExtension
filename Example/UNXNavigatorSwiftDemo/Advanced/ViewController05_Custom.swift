...
class ViewController05_Custom: BaseTableViewController {
    ...
    private lazy var backButton: UIButton = {
        ...
        button.addTarget(self.navigationController, action: #selector(navigationController?.unx_triggerSystemBackButtonHandler), for: .touchUpInside)
        return button
    }()
    ...
    override func viewDidLoad() {
        ...
        unx_navigationBar.addContainerSubview(searchBar)
        unx_navigationBar.addContainerSubview(backButton)
        unx_navigationBar.addContainerSubview(addButton)
